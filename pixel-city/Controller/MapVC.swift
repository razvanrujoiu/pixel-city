...
class MapVC: UIViewController, UIGestureRecognizerDelegate {
    ...
    let authoriationStatus = CLLocationManager.authorizationStatus()
    ...
    override func viewDidLoad() {
        ...
        collectionView?.backgroundColor = #colorLiteral(red: 0.9385011792, green: 0.7164435983, blue: 0.3331357837, alpha: 1)
    ...
    @IBAction func centerMapBtnWasPressed(_ sender: Any) {
        if authoriationStatus == .authorizedAlways || authoriationStatus == .authorizedWhenInUse {
...
extension MapVC: CLLocationManagerDelegate {
    func configureLocationServices() {
        if authoriationStatus == .notDetermined {
